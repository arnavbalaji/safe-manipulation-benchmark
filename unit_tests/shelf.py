...
def __main__():
    ...
    if args.visualize:
        ...
        target_objects.append("vase@meta__base_link_fillable_0_0_link")
        all_obj_healths = np.array(f["data/demo_0/obs/health"])
        health_list_link_names = f["data/demo_0"].attrs["health_list_link_names"]
        health = dict()
        # print(health_list_link_names)
        print(np.array(f['data/demo_0/obs/health']))
        print(f['data/demo_0/obs'].keys())
        print("Attrs:", dict(f["data/demo_0"].attrs))
        ...
        if arrays:
            ...
            health["tiago0"] = None
        health["vase"] = np.minimum.reduce([v for k, v in health.items() if k.startswith("vase@meta__base_link_fillable_0_0_link")])
        # print(health["vase"][0].shape)
        ...
        target_objects_forces.append("vase@meta__base_link_fillable_0_0_link")
        data = dict()
        ...
        print(data["vase@meta__base_link_fillable_0_0_link"])
