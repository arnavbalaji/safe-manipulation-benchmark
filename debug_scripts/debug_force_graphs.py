...
def __main__():
    ...
    EXTERNAL_CAMERA_CONFIGS = {
        ...
        "external_sensor_1": {
            ...
            "relative_prim_path": f"/controllable__damageable{robot_type}__{robot_name}/eyes/external_sensor1",
        },
    ...
    if teleop:
        ...
        # robot.set_joint_positions(th.tensor([-1.5, -1.0]), indices=robot.camera_control_idx)
